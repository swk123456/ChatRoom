...
void LoginForm::client_login_handler(int success, QJsonObject myinfo)
{
    if (success == 0)
    {
        QMessageBox::warning(this, QString::fromLocal8Bit("登录提示 "), QString::fromLocal8Bit("用户id或密码错误 "));
    }
    else if(success == 1)
    {
    ...
    {
        QMessageBox::warning(this, QString::fromLocal8Bit("登录提示 "), QString::fromLocal8Bit("服务器错误 "));
    }
}
